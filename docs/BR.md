...
>>>>>>> 78d8738ed7ebfd825bc21a92ddc0b42ed3804ee0
The CA SHALL implement a Trustworthy System or process which identifies Forbidden, Weak, or Compromised Keys (such as a Debian weak key, see https://wiki.debian.org/SSLkeys). The CA MUST reject any certificate request for a key identifiable as a Forbidden, Weak, or Compromised Key. Upon identifying a Key Compromise, the CA MUST revoke all non-expired Subscriber Certificates which use the Compromised Key. The CA MUST reject any certificate request for a key generated by the CA.
